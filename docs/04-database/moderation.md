...
Two items remain genuinely deferred, not because they're undecided but because they belong to a later phase, not this schema document:

- **Whether a lifted community member is auto-reactivated or must be re-invited** (§7's `liftMembershipSanction` note) — Community module's own membership-lifecycle decision.
